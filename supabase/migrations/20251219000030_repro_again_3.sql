...
BEGIN
    ...
    INSERT INTO products (sku, name, status) VALUES ('TEST-SKU-3', 'Test Product 3', 'active') RETURNING id INTO v_prod;
    INSERT INTO locations (name, is_sellable) VALUES ('TEST-LOC-3', true) RETURNING id INTO v_loc;

...
BEGIN
    ...
    INSERT INTO products (sku, name, status) VALUES ('TEST-SKU-6', 'Test Product 6', 'active') RETURNING id INTO v_prod;
    INSERT INTO locations (name, is_sellable) VALUES ('TEST-LOC-6', true) RETURNING id INTO v_loc;

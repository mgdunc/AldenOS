...
BEGIN
    ...
    INSERT INTO products (sku, name, status) VALUES ('TEST-SKU-4', 'Test Product 4', 'active') RETURNING id INTO v_prod;
    INSERT INTO locations (name, is_sellable) VALUES ('TEST-LOC-4', true) RETURNING id INTO v_loc;
